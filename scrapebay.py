#scrapes ebay sold page 1 at a time and inserts data for each product sold into a three table mysql database
import requests
...
#variables for use in mysql queries
URL = cleanURL 
